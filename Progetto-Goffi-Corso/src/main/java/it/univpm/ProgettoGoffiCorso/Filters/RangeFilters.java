...
public class RangeFilters {
	...
	/**Metodo che filtra le previsioni in base ad una soglia di errore in hPa e restituisce soltanto le previsioni del giorno seguente 
	 * nel caso di soglia uguale a 1; solo quelle tra 1,2 e 4 giorni nel caso di soglia uguale a 2; solo quelle tra 1,2,4,5 giorni nel
	 * caso di soglia >= 3 e < 6; tutte nel caso di soglia >= 6.(Per fare ciò abbiamo salvato dati correnti e previsioni su dei file di testo
	 * e li abbiamo confrontati stimando l'accuratezza delle previsioni di OpenWeather.)
	 * @param soglia
	 * @param f
	 */
